...
function Get-CaptureDevices 
{
    ...
    Select-Object @{Name="CaptureDeviceId";Expression={$_.PSParentPath.substring($_.PSParentPath.length - 38, 38)}}, 
...
function Get-CaptureDeviceId 
{
    ...
    Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\MMDevices\Audio\capture\*\Properties\" |
    Where-Object {($_."{a45c254e-df1c-4efd-8020-67d146a850e0},2" -eq $captureDeviceName) -and ($_."{b3f8fa53-0004-438e-9003-51a46e139bfc},6" -eq $captureDeviceInterface)} |
    ForEach-Object {$_.PSParentPath.substring($_.PSParentPath.length - 38, 38)}
}
...
function Get-RenderDeviceId 
{
    ...
    Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\MMDevices\Audio\Render\*\Properties\" |
    Where-Object {($_."{a45c254e-df1c-4efd-8020-67d146a850e0},2" -eq $renderDeviceName) -and ($_."{b3f8fa53-0004-438e-9003-51a46e139bfc},6" -eq $renderDeviceInterface)} |
    ForEach-Object {$_.PSParentPath.substring($_.PSParentPath.length - 38, 38)}
}
